...
static void SigCatcherCommon(int s, void *context, siginfo_t *info,
                             ucontext_t *ucontext);
static void SigCallChain(int s, void *context, siginfo_t *info,
                         ucontext_t *ucontext);
...
#if __linux__
         (*(SigOldLinux *) c->oldCatcher)(s, *(struct sigcontext *)context);
#else
