...
$ tar zxf VMware-view-open-client-2.1.1-153227.tar.gz

To run, navigate to the 'bin' subdirectory and run directly from the
command line:

$ cd VMware-view-open-client-2.1.1-153227/bin
$ ./vmware-view
...
*) There is no log collection script in this release (bz 315390)
...
*) Fullscreen toolbar
*) F5 Refresh of desktop list (bz 291918)
*) Log collection script (bz 315390)
